            ...
            >
                <div className="grid grid-cols-2 justify-between items-center gap-10">
                    <div className="h-screen bg-white w-full max-w-xl shrink-0 shadow-2xl items-center py-5 px-10">
                        <div className="flex justify-between items-center">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <Link href={"/signup"} className="bg-black rounded-full text-white px-3 py-1.5 text-xs">
                                    <p className="tex-xs">Create Account</p>
                                </Link>
                            </div>
                        </div>
                        ...
                        <div className="py-1">
                            <button className="btn w-full bg-white shadow-xl space-x-2 text-black hover:text-white hover:bg-black"><FaGoogle />Signin with Google</button>
                        </div>
                        <div className="py-1">
                            <button className="btn w-full bg-black shadow-xl space-x-2 text-white hover:bg-white hover:text-black"><FaWallet />Connect Wallet</button>
                        </div>
                        <div className="py-1">
