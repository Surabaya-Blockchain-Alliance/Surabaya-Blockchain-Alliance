...
const JoinCommunity: React.FC = () => {
    return (
        <div
            ...
            <div className="cursor-pointer hover:scale-95 duration-300 ease-out transform transition-all w-screen p-10 overflow-hidden">
                <Link href="/community" className="card image-full h-60 rounded-2xl">
                    <img
