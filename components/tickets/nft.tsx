    ...
    >
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-2 sm:gap-0">
        ...
        <div className="text-xs sm:text-sm text-gray-600 text-right leading-tight max-w-lg">
          <div><strong>Certificate no:</strong> <span className='uppercase'>{eventId}</span></div>
          <div><strong>Reference Number:</strong> <span className='uppercase'>{reffNumber}</span></div>
        </div>
      </div>
      ...
      {/* Course Title */}
      <h1 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4 leading-snug">
        {title}
      </h1>
