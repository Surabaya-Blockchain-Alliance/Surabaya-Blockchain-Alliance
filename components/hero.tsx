                ...
                <div className="hero-content text-neutral-content text-center py-40">
                    <div className="max-w-xl space-y-5">
                        ...
                        <h1 className="mb-5 text-5xl font-bold text-gray-100" data-aos="fade-up">
                            A platform to engage users and communities to make projects more recognizable
                        </h1>
                        ...
                        <Link data-aos="fade-up" className="btn bg-transparent border-white font-bold border-2 rounded-full hover:text-white hover:border-black px-6 text-white" href={""}>Start Creating Quests <BsArrowRight className="text-xs" /></Link>
                    </div>
                </div>
            </div>
        </div>
